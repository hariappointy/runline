...
export default function telegram(rl: RunlinePluginAPI) {
  ...
  rl.registerAction("message.edit", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { chat_id: p.chatId, message_id: p.messageId, text: p.text };
      if (p.parseMode) body.parse_mode = p.parseMode;
  ...
  rl.registerAction("message.pin", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { chat_id: p.chatId, message_id: p.messageId };
      if (p.disableNotification) body.disable_notification = true;
  ...
  rl.registerAction("message.sendPhoto", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { chat_id: p.chatId, photo: p.photo };
  ...
  rl.registerAction("message.sendDocument", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { chat_id: p.chatId, document: p.document };
      if (p.caption) body.caption = p.caption;
  ...
  rl.registerAction("message.sendVideo", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { chat_id: p.chatId, video: p.video };
      if (p.caption) body.caption = p.caption;
  ...
  rl.registerAction("message.sendAnimation", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { chat_id: p.chatId, animation: p.animation };
      if (p.caption) body.caption = p.caption;
  ...
  rl.registerAction("message.sendAudio", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { chat_id: p.chatId, audio: p.audio };
      if (p.caption) body.caption = p.caption;
  ...
  rl.registerAction("chat.get", {
    ...
    async execute(input, ctx) { return apiRequest(getConn(ctx), "POST", "getChat", { chat_id: (input as Record<string, unknown>).chatId }); },
  });

  rl.registerAction("chat.getAdministrators", {
    description: "Get chat administrators",
    inputSchema: { chatId: { type: "string", required: true } },
    async execute(input, ctx) { return apiRequest(getConn(ctx), "POST", "getChatAdministrators", { chat_id: (input as Record<string, unknown>).chatId }); },
  });
  ...
  rl.registerAction("chat.leave", {
    ...
    inputSchema: { chatId: { type: "string", required: true } },
    async execute(input, ctx) { return apiRequest(getConn(ctx), "POST", "leaveChat", { chat_id: (input as Record<string, unknown>).chatId }); },
  });
  ...
  rl.registerAction("callback.answer", {
    ...
    async execute(input, ctx) {
      const p = input as Record<string, unknown>;
      const body: Record<string, unknown> = { callback_query_id: p.callbackQueryId };
  ...
  rl.registerAction("file.get", {
    ...
    async execute(input, ctx) { return apiRequest(getConn(ctx), "POST", "getFile", { file_id: (input as Record<string, unknown>).fileId }); },
  });
}
